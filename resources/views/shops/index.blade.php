...
<body>
                ...
                <div class="row mt">
                    <div class="col-md-12">
                        <div class="content-panel">
                            {!! Form::open(['method' => 'GET', 'url' => '/shops', 'class' => '', 'role' => 'search']) !!}
                            ...
                            <table id="table_customers" class="" style="width: 100%">
                                ...
                                <tbody>
                                    @foreach ($posts as $data)
                                        <tr>
                                            <td>
                                                <a href="{{ url('/shops/post/' . $data->id) }}">{{ $data->id }}</a>
                                            </td>
                                            <td>
                                                {{ $data->title }}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <img src="https://prdapp.hunegroup.com/fileupload/Shop/{{ $data->image }}" alt="" style="border:0;" height="50" width="80">
                                                @endif
                                            </td>
                                            <td>
    ...
    @include('handle_js.dataTables_Shop')
