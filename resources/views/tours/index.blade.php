...
<body>
                            ...
                            <table id="table_customers" class="" style="width: 100%">
                                ...
                                <tbody>
                                    @foreach ($posts as $data)
                                        <tr>
                                            <td>
                                                <a href="{{ url('/tours/post/' . $data->id) }}">{{ $data->id }}</a>
                                            </td>
                                            <td>
                                                {{ $data->title }}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <img src="https://prdapp.hunegroup.com/fileupload/Tour/{{ $data->image }}" alt="" style="border:0;" height="50" width="80">
                                                @endif
                                            </td>
                                            <td>
    ...
    @include('handle_js.dataTables_Tour')
