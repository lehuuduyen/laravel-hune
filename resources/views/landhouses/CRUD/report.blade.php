            ...
            <section class="wrapper">
                ...
                <div class="row mt">
                    <div class="col-md-12">
                                    ...
                                    <table id="table_customers" style="width: 100%" class="">
                                        ...
                                        <tbody>
                                            @foreach ($reports as $data)
                                                <tr id="tr-{{ $data->id }}">
                                                    <td id="report-id-{{ $data->id }}">
                                                        <a href="{{ url('/landhouses/list-report/' . $data->id) }}">{{ $data->id }}</a>
                                                    </td>
                                                    <td id="report-name-{{ $data->id }}">
                                                        <a href="{{ url('/landhouses/list-report/' . $data->id) }}">{{ $data->name }}</a>
                                                    </td>
                                                    <td id="report-date-{{ $data->id }}">{{ $data->date_created }}</td>
                                                    <td id="report-status-{{ $data->id }}">
                                                    ...
                                                    <td>
                                                        <a value="{{ $data->id }}" href="#editReportModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                        <a value="{{ $data->id }}" href="#deleteReportModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                        ...
                                        <form>
                                            ...
                                            <div class="modal-body">					
                                                <div class="form-group">
                                                    <label>Name</label>
                                                    <input type="text" class="form-control add-report-name" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Date Create</label>
                                                    <input type="date" class="form-control add-report-date" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Status</label>
                                                    <select class="add-report-status">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="submit" class="btn btn-success add-report" value="Add">
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form>
                                            ...
                                            <div class="modal-footer">
                                                <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                                                <input type="submit" class="btn btn-info edit-report" value="Save">
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form>
                                            ...
                                            <div class="modal-footer">
                                                <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                                                <input set-id="" type="submit" class="btn btn-danger delete-report" value="Delete">
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div class=""> {!! $reports->appends(['search' => Request::get('search')])->render() !!} </div>
                        <!-- /content-panel -->
                    </div>
                    <!-- /col-md-12 -->
                </div>
