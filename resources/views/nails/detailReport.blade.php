                ...
                <div class="row mt">
                    <div class="col-md-12">
                        <div class="content-panel">
                            {!! Form::open(['method' => 'GET', 'url' => '/nails/list-report/'.$id, 'class' => '', 'role' => 'search']) !!}
                                ...
                                <tbody>
                                    @foreach ($posts as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('/nails/post/' . $data->post_id) }}">{{ $data->title }}</a>
                                            </td>
                                            <td>
                                                <a href="{{ url('/nails/list-report/' . $data->type_report_id) }}">{{ $data->name }}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
