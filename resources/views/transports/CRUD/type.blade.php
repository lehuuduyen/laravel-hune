            ...
            <section class="wrapper">
                ...
                <div class="row mt">
                    <div class="col-md-12">
                                    ...
                                    <div class="table-title">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                {{-- <a href="#deleteTypeModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a>						 --}}
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class=""> {!! $types->appends(['search' => Request::get('search')])->render() !!} </div>
                        <!-- /content-panel -->
                    </div>
                    <!-- /col-md-12 -->
                </div>
