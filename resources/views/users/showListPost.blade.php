                ...
                <div class="row mt">
                    <div class="col-md-12">
                        <div class="content-panel">
                            {!! Form::open(['method' => 'GET', 'url' => '/'.$navi, 'class' => '', 'role' => 'search']) !!}
                            ...
                            <table id="table_customers" class="" style="width: 100%">
                                ...
                                <tbody>
                                    @foreach ($posts as $data)
                                        <tr>
                                            <td>
                                                <a href="{{ url('/'.$navi.'/'.'post/' . $data->id) }}">{{ $data->id }}</a>
                                            </td>
                                            <td>
                                                {{ $data->title }}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                <img src="https://prdapp.hunegroup.com/fileupload/{{ $file_upload }}/{{ $data->image }}" alt="" style="border:0;" height="50" width="80">
                                                @endif
                                            </td>
                                            <td>
