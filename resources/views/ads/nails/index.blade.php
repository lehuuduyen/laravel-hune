                ...
                <div class="row mt">
                    <div class="col-md-12">
                        <div class="content-panel">
                            {!! Form::open(['method' => 'GET', 'url' => '/ads/nails', 'class' => '', 'role' => 'search']) !!}
                                ...
                                <tbody>
                                    @foreach ($posts as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->user_id }}</td>
                                            <td>
                                                <a href="{{ url('/nails/post/' . $data->post_id) }}">{{ $data->post_id }}</a>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <button id="{{ $data->id }}" type_ser="4" ads_name="{{ $data->ads_name }}" post_id="{{ $data->post_id }}" user_id="{{ $data->user_id }}" data-original-title="Mở/Đóng" value="{{ $data->status }}" class="power_off btn btn-danger btn-xs tooltips"><i class="fa fa-power-off"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
