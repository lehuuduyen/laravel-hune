...
<body>
                ...
                <div class="row mt">
                    <div class="col-md-12">
                        <div class="content-panel">
                            {!! Form::open(['method' => 'GET', 'url' => '/promotions', 'class' => '', 'role' => 'search']) !!}
                            ...
                            <table id="table_customers" class="" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{ url('/promotions/post/' . $data->id) }}">{{ $data->id }}</a>
                                            </td>
                                            <td>
                                                {{ $data->title }}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <img src="https://prdapp.hunegroup.com/fileupload/Promotion/{{ $data->image }}" alt="" style="border:0;" height="50" width="80">
                                                @endif
                                            </td>
                                            <td>
                                                ...
                                                <button id_ads="{{ $id_ads }}" id="{{ $data->id }}" user_id="{{ $data->user_id }}" title_post="{{ $data->title }}" data-original-title="Mở/Đóng" value="{{ $data->status }}" class="power_off btn btn-danger btn-xs tooltips"><i class="fa fa-power-off"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
    ...
    @include('handle_js.dataTables_Pro')
