                                ...
                                <div class="table-wrapper">
                                    <div class="table-title">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <a href="<?php echo e(url('/video/create')); ?>" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Video</span></a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr id="tr-<?php echo e($data->id); ?>">
                                                    <td id="video-id-<?php echo e($data->id); ?>">
                                                        <a href="<?php echo e(url('/video'. '/' . $data->id)); ?>"><?php echo e($data->video_name); ?></a>
                                                    </td>
                                                    <td id="video-url-<?php echo e($data->id); ?>"><?php echo e($data->servicecode); ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php else: ?>
                                                            <?php if(strpos($data->thumbnail, 'http') !== false): ?>
                                                                <img src="https://img.icons8.com/ios-filled/50/000000/user.png" alt="" style="border:0;" height="50" width="80">
                                                            <?php else: ?>
                                                                <img src="https://prdapp.hunegroup.com/fileupload/Ads/<?php echo e($data->thumbnail); ?>" alt="" style="border:0;" height="50" width="80">
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td id="video-status-<?php echo e($data->id); ?>">
                                                    ...
                                                    <td>
                                                        <a value="<?php echo e($data->id); ?>" href="<?php echo e(url('/video'. '/' . $data->id . '/edit')); ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                        <?php echo Form::open([
                                                            'method' => 'DELETE',
                                                            'url' => ['/video', $data->id],
...
</html><?php /**PATH C:\xampp\htdocs\Hune_Admin\resources\views/ads/listVideo.blade.php ENDPATH**/ ?>