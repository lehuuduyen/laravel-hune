<script>
    $(document).ready( function () {
        ...
        $('button.power_off').click(function() {
            var status = $(this).val();
            var id = $(this).attr('id');
            var id_ads = $(this).attr('id_ads');
            var user_id = $(this).attr('user_id');
            var title = $(this).attr('title_post');
            var old_status = $('#status-'+id+' span').html();

            if (old_status == 'Off' && id_ads != null) {
...
</script><?php /**PATH C:\xampp\htdocs\Hune_Admin\resources\views/handle_js/dataTables_Pro.blade.php ENDPATH**/ ?>