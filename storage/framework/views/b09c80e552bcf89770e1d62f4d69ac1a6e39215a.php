                ...
                <div class="row mt">
                    <div class="col-md-12">
                        <div class="content-panel">
                            <?php echo Form::open(['method' => 'GET', 'url' => '/ads/landhouses', 'class' => '', 'role' => 'search']); ?>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(url('/landhouses/post/' . $data->post_id)); ?>"><?php echo e($data->post_id); ?></a>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <button id="<?php echo e($data->id); ?>" type_ser="2" ads_name="<?php echo e($data->ads_name); ?>" post_id="<?php echo e($data->post_id); ?>" user_id="<?php echo e($data->user_id); ?>" data-original-title="Mở/Đóng" value="<?php echo e($data->status); ?>" class="power_off btn btn-danger btn-xs tooltips"><i class="fa fa-power-off"></i></button>
                                            </td>
                                        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\Hune_Admin\resources\views/ads/landhouses/index.blade.php ENDPATH**/ ?>