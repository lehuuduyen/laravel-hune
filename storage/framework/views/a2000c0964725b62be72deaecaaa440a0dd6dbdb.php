...
<body>
                ...
                <div class="row mt">
                    <div class="col-md-12">
                        <div class="content-panel">
                            <?php echo Form::open(['method' => 'GET', 'url' => '/recruitments', 'class' => '', 'role' => 'search']); ?>
                            ...
                            <table id="table_customers" class="" style="width: 100%">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <a href="<?php echo e(url('/recruitments/post/' . $data->id)); ?>"><?php echo e($data->id); ?></a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <img src="https://prdapp.hunegroup.com/fileupload/Recruitment/<?php echo e($data->image); ?>" alt="" style="border:0;" height="50" width="80">
                                                <?php endif; ?>
                                            </td>
                                            <td>
    ...
    <?php echo $__env->make('handle_js.dataTables_Recr', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('handle_js.approvedPost', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</body>

</html><?php /**PATH C:\xampp\htdocs\Hune_Admin\resources\views/recruitments/index.blade.php ENDPATH**/ ?>