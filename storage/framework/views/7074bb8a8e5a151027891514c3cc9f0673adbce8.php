...
<body>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr id="tr-<?php echo e($data->id); ?>">
                                                    ...
                                                    <td id="coupon-used-<?php echo e($data->id); ?>"><?php echo e($data->count_coupon); ?></td>
    ...
    <?php echo $__env->make('handle_js.couponUsed', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</html><?php /**PATH C:\xampp\htdocs\Hune_Admin\resources\views/coupons/getUsed.blade.php ENDPATH**/ ?>