                            ...
                            <div class="wrapper row" style="margin-top: 40px;">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="preview-pic tab-content">
                                            <?php for($i = 0; $i < count($array_photo); $i++): ?>
                                                <?php if($i == 0): ?>
                                                    <div class="tab-pane active" id="pic-<?php echo e($i); ?>"><img style="height: 100%; width: 100%; object-fit: contain;" src="https://prdapp.hunegroup.com/fileupload/Recruitment/<?php echo e($array_photo[$i]); ?>" /></div>
                                                <?php else: ?>
                                                    <div class="tab-pane" id="pic-<?php echo e($i); ?>"><img style="height: 100%; width: 100%; object-fit: contain;" src="https://prdapp.hunegroup.com/fileupload/Recruitment/<?php echo e($array_photo[$i]); ?>" /></div>
                                                <?php endif; ?>
                                            <?php endfor; ?>
                                        </div>
                                        <ul class="preview-thumbnail nav nav-tabs">
                                            <?php for($i = 0; $i < count($array_photo); $i++): ?>
                                                <?php if($i == 0): ?>
                                                    <li class="active"><a data-target="#pic-<?php echo e($i); ?>" data-toggle="tab"><img style="height: 100%; width: 100%; object-fit: contain;" src="https://prdapp.hunegroup.com/fileupload/Recruitment/<?php echo e($array_photo[$i]); ?>" /></a></li>
                                                <?php else: ?>
                                                    <li><a data-target="#pic-<?php echo e($i); ?>" data-toggle="tab"><img style="height: 100%; width: 100%; object-fit: contain;" src="https://prdapp.hunegroup.com/fileupload/Recruitment/<?php echo e($array_photo[$i]); ?>" /></a></li>
                                                <?php endif; ?>
                                            <?php endfor; ?>
                                        </ul>
                                    <?php endif; ?>
                                ...
                                <div class="details col-md-6">
                                    ...
                                    <h5 class="sizes">User_ID:
                                        <a href="<?php echo e(url('show-list-post?id='.$post->user_id.'&service=7')); ?>">
...
<script>
    function set_on_off(id, status) {
        $.ajax({
            url: "<?php echo url('') ?>/recruitments/status",
            data: {
                'id': id,
                'status': status
            },
...
<?php /**PATH C:\xampp\htdocs\Hune_Admin\resources\views/recruitments/detail.blade.php ENDPATH**/ ?>