...
<body>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr id="tr-<?php echo e($data->id); ?>">
                                                    <td id="type-id-<?php echo e($data->id); ?>"><?php echo e($data->id); ?></td>
                                                    <td id="type-name-<?php echo e($data->id); ?>"><?php echo e($data->name); ?></td>
                                                    <td id="type-date-<?php echo e($data->id); ?>"><?php echo e($data->date_created); ?></td>
                                                    <td id="type-status-<?php echo e($data->id); ?>">
                                                    ...
                                                    <td>
                                                        <a value="<?php echo e($data->id); ?>" href="#editTypeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                        <a value="<?php echo e($data->id); ?>" href="#deleteTypeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                                    </td>
                                                </tr>
    ...
    <?php echo $__env->make('handle_js.type', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</html><?php /**PATH C:\xampp\htdocs\Hune_Admin\resources\views/nails/CRUD/type.blade.php ENDPATH**/ ?>