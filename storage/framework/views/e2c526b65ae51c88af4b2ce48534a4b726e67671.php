...
<body>
                        ...
                        <div class="content-panel">
                            ...
                            <?php echo Form::model($post, [
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="banner-url" type="text" class="form-control" value="<?php echo e($post->url); ?>" id="banner-url">
                                </div>
                                <?php if(isset($post->photos)): ?>
                                    <div class="form-group">
                                        <label>Old Image</label></br>
                                        <img src="https://prdapp.hunegroup.com/fileupload/Ads/<?php echo e($post->photos); ?>" alt="" width="150" height="150">
                                    </div>
                                <?php endif; ?>
                                <div class="form-group">
                                    <label>Image</label>
                                    <input type="file" class="form-control" id="banner-image"  accept="image/*">
                                    <input value="<?php echo e($post->photos); ?>" hidden name="banner-image" type="text" id="add-image">
                                    <input value="<?php echo e($post->latitude); ?>" hidden name="banner-lat" type="text" id="lat">
                                    <input value="<?php echo e($post->longitude); ?>" hidden name="banner-long" type="text" id="long">
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
                                    <?php
                                    ...
                                    ?>
                                    <select name="banner-status" class="banner-status" value="<?php echo e($selected); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="width: 200px" value="<?php echo e($strip); ?>" type="date" class="form-control" name="banner-date">
                                </div>
                                <div class="form-group">
                                    <!-- Search input -->
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBvASYR4CMIQz345Dr7Ni27svGfldPN_NQ&libraries=places&callback=initAutocomplete"
         async defer></script>
</html><?php /**PATH C:\xampp\htdocs\Hune_Admin\resources\views/ads/editBanner.blade.php ENDPATH**/ ?>